...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: VTX27BUXzAtl/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: HRy9f8K8aHUl/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: b_2wQd1UmLiE/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__fhHjh)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__cGkCi)}
                role={"img"}
              />
            ),
